		...
		<div class="row" id="recipe_detail">
			<table class="table">
				<tbody>
					...
					<tr>
						<td class="text-center" colspan="3">
							<h3 class="text-ceeter">{{store.detail.vo.title}}</h3>
						</td>
					</tr>
					<tr>
						<td class="text-center" colspan="3">
					...
					<tr>
						<td class="text-right" colspan="3">
							<button type="button" class="btn-sm btn-primary">(FullCalendar)예약</button>
			...
			<table class="table">
				<tbody>
					<tr>
						<td colspan="2"><h3>[조리 순서]</h3></td>
					</tr>
					<tr v-for="(data, index) in store.detail.tList">
						<td class="text-left" width="85%">{{data}}</td>
						<td class="text-right" width="15%">
							<img :src="store.detail.iList[index]" style="width: 180px; height: 60px">
						</td>
					</tr>
				</tbody>
			</table>
			<table class="table">
				<tbody>
					...
					<tr>
						...
						<td width="80px">{{store.detail.vo.chef}}</td>
					</tr>
					<tr>
